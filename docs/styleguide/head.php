...
<div class="styleguide__wrapper">
	<p class="styleguide__headding01">_head</p>
	<i class="styleguide__file">html\_src\scss\04_modules\_head.scss</i>
	
	<p class="styleguide__comment">タイトルよりもやや複雑なヘッド要素へ</p>
...
<div class="styleguide__navi--bottom">
	<ul class="styleguide__navi_list">
		...
		<li class="styleguide__navi_item"><a class=' styleguide__active' href='head.php'>
			head</a></li>
