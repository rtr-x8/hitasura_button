...
<div class="styleguide__wrapper">
	<p class="styleguide__headding01">_table</p>
	<i class="styleguide__file">html\_src\scss\04_modules\_table.scss</i>
	
	<p class="styleguide__comment">テーブル</p>
...
<div class="styleguide__navi--bottom">
	<ul class="styleguide__navi_list">
		...
		<li class="styleguide__navi_item"><a class=' styleguide__active' href='table.php'>
			テーブル</a></li>
