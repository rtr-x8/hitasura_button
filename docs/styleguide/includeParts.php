...
<div class="styleguide__wrapper">
	<p class="styleguide__headding01">_includeParts</p>
	<i class="styleguide__file">html\_src\scss\04_modules\_includeParts.scss</i>
	

	
		
		<div class="styleguide__article">
			<p class="styleguide__headding03">cv01</p>
			<ul class="styleguide__labelList">
				
			</ul>
			<p class="styleguide__comment">				&lt;?php include($_SERVER['DOCUMENT_ROOT'].'/common/inc/cv01.php'); ?&gt;</p>
...
<div class="styleguide__navi--bottom">
	<ul class="styleguide__navi_list">
		...
		<li class="styleguide__navi_item"><a class=' styleguide__active' href='includeParts.php'>
			_includeParts</a></li>
