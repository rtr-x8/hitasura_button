...
<div class="styleguide__wrapper">
	<p class="styleguide__headding01">_wrap</p>
	<i class="styleguide__file">html\_src\scss\04_modules\_wrap.scss</i>
	
	<p class="styleguide__comment">箱型モジュール、</p>
	

	
		
		<div class="styleguide__article">
			<p class="styleguide__headding03">.cmn_wrap01</p>
			<ul class="styleguide__labelList">
				
			</ul>
			<p class="styleguide__comment">PCで幅1000pxで中央表示</p>
			<div class="styleguide__preview">
				<div class="styleguide__previewIn">
<div class='cmn_wrap01'>.cmn_wrap01</div>
</div>
			</div>
...
<div class="styleguide__navi--bottom">
	<ul class="styleguide__navi_list">
		...
		<li class="styleguide__navi_item"><a class=' styleguide__active' href='wrap.php'>
			Box、装飾、table</a></li>
