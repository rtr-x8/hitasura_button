...
var dst = {
	...
	js        : site_root + 'js/',
	img       : site_root + 'img/',
	sprite    : site_root + 'img/modules/',
	favicon   : site_root + 'img/favicons/',
	font      : site_root + 'fonts/',
	svg       : site_root + 'svg/',
...
module.exports = {
	...
	watch: {
		before_tasks: ['connectSync', 'imagemin','bs-reload','pug','js', 'styleguide'],
	...
	imagemin: {
		src: [
			src.img + '**/*.{jpg,jpeg,png,gif,JPG,JPEG,PNG,GIF}',
			'!' + src.img + '**/_*.{jpg,jpeg,png,gif,JPG,JPEG,PNG,GIF}',
