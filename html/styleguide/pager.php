...
<div class="styleguide__wrapper">
	<p class="styleguide__headding01">_pager</p>
	<i class="styleguide__file">html\_src\scss\04_modules\_pager.scss</i>
	
	<p class="styleguide__comment">ページャー</p>
	

	
		
		<div class="styleguide__article">
			<p class="styleguide__headding03">上下余白は各ページ調整してください。</p>
...
<div class="styleguide__navi--bottom">
	<ul class="styleguide__navi_list">
		...
		<li class="styleguide__navi_item"><a class=' styleguide__active' href='pager.php'>
			ページャー</a></li>
