...
<div class="styleguide__wrapper">
	<p class="styleguide__headding01">_button</p>
	<i class="styleguide__file">html\_src\scss\04_modules\_button.scss</i>
	
	<p class="styleguide__comment">ボタン類</p>
	

	
		
		<div class="styleguide__article">
			<p class="styleguide__headding03">text</p>
			<ul class="styleguide__labelList">
				
			</ul>
			<p class="styleguide__comment">text</p>
...
<div class="styleguide__navi--bottom">
	<ul class="styleguide__navi_list">
		...
		<li class="styleguide__navi_item"><a class=' styleguide__active' href='button.php'>
			ボタン</a></li>
