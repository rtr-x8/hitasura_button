...
<div class="styleguide__wrapper">
	<p class="styleguide__headding01">_icon</p>
	<i class="styleguide__file">html\_src\scss\04_modules\_icon.scss</i>
	
	<p class="styleguide__comment">スプライトでないアイコン</p>
	

	
		
		<div class="styleguide__article">
			<p class="styleguide__headding03">アイコン１　.c_icon01</p>
...
<div class="styleguide__navi--bottom">
	<ul class="styleguide__navi_list">
		...
		<li class="styleguide__navi_item"><a class=' styleguide__active' href='icon.php'>
			アイコン</a></li>
