...
<div class="styleguide__wrapper">
	<p class="styleguide__headding01">_text</p>
	<i class="styleguide__file">html\_src\scss\04_modules\_text.scss</i>
	
	<p class="styleguide__comment">テキスト類もろもろ<br>リスト、インラインリンク、リスト</p>
...
<div class="styleguide__navi--bottom">
	<ul class="styleguide__navi_list">
		...
		<li class="styleguide__navi_item"><a class=' styleguide__active' href='text.php'>
			テキスト</a></li>
