...
<div class="styleguide__wrapper">
	<p class="styleguide__headding01">_bg</p>
	<i class="styleguide__file">html\_src\scss\04_modules\_bg.scss</i>
	
	<p class="styleguide__comment">背景パターン集</p>
	

	
		
		<div class="styleguide__article">
			<p class="styleguide__headding03"></p>
			<ul class="styleguide__labelList">
				
			</ul>
			<p class="styleguide__comment"></p>
			<div class="styleguide__preview">
				<div class="styleguide__previewIn">
<div class='cf'>
<div class='cmn_bg-pattern01 dev_fl01'>cmn_bg-pattern01</div>
</div>
</div>
			</div>
...
<div class="styleguide__navi--bottom">
	<ul class="styleguide__navi_list">
		...
		<li class="styleguide__navi_item"><a class=' styleguide__active' href='bg.php'>
			背景</a></li>
