...
<div class="styleguide__wrapper">
	<p class="styleguide__headding01">_box</p>
	<i class="styleguide__file">html\_src\scss\04_modules\_box.scss</i>
...
<div class="styleguide__navi--bottom">
	<ul class="styleguide__navi_list">
		...
		<li class="styleguide__navi_item"><a class=' styleguide__active' href='box.php'>
			Box、装飾、table</a></li>
